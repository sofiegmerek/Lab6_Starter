...
class RecipeCard extends HTMLElement {
 ...
 `
  ...
  <p class="ingredients">
    ...
    myarticle.getElementsByClassName('organization')[0].textContent = data.organization;
    myarticle.getElementsByClassName('rating')[0].querySelector('span').textContent = data.rating;
    myarticle.getElementsByTagName('span')[1].textContent = data.numRatings;
    myarticle.getElementsByTagName('time')[0].textContent = data.lengthTime;
    myarticle.getElementsByClassName('ingredients')[0].textContent = data.ingredients;
